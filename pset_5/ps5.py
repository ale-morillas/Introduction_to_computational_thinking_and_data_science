...
def gen_std_devs(climate, multi_cities, years):
    ...
    annual_std_dev = pylab.array(annual_std_dev)
...
if __name__ == '__main__':
    ...
    # year_data = pylab.array(TESTING_INTERVAL)
    # all_cities_avg_testing = gen_cities_avg(data_file, CITIES, TESTING_INTERVAL)
    # moved_average_cities_testing = moving_average(all_cities_avg_testing, 5)
    # evaluate_models_on_testing(year_data, moved_average_cities_testing, all_cities_models)
